...
func NewATodoListApplicationAPI(spec *loads.Document) *ATodoListApplicationAPI {
	return &ATodoListApplicationAPI{
		...
		TodosDeleteTodoHandler: todos.DeleteTodoHandlerFunc(func(params todos.DeleteTodoParams) middleware.Responder {
			return middleware.NotImplemented("operation TodosDeleteTodo has not yet been implemented")
		}),
		ConsumersFindConsumerHandler: consumers.FindConsumerHandlerFunc(func(params consumers.FindConsumerParams) middleware.Responder {
			return middleware.NotImplemented("operation ConsumersFindConsumer has not yet been implemented")
		}),
...
/*ATodoListApplicationAPI From the todo list tutorial on goswagger.io */
type ATodoListApplicationAPI struct {
	...
	// ConsumersFindConsumerHandler sets the operation handler for the find consumer operation
	ConsumersFindConsumerHandler consumers.FindConsumerHandler
...
func (o *ATodoListApplicationAPI) Validate() error {
	...
	if o.ConsumersFindConsumerHandler == nil {
		unregistered = append(unregistered, "consumers.FindConsumerHandler")
	}
...
// Context returns the middleware context for the a todo list application API
...
func (o *ATodoListApplicationAPI) initHandlerCache() {
	...
	o.handlers["DELETE"]["/todos/{id}"] = todos.NewDeleteTodo(o.context, o.TodosDeleteTodoHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/consumers/{id}"] = consumers.NewFindConsumer(o.context, o.ConsumersFindConsumerHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/todos"] = todos.NewFindTodos(o.context, o.TodosFindTodosHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/todos/{id}"] = todos.NewGetTodo(o.context, o.TodosGetTodoHandler)
